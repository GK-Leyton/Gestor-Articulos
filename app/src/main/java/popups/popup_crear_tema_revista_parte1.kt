...
class PopupHelperCrearTemaRevista(private val context: Context) {

    var url = URL.BASE_URL+"Tema/CrearTemaRevista.php"

    fun showPopup(anchorView: View) {
        val popupView = LayoutInflater.from(context).inflate(R.layout.popup_crear_tema_revista, null)
        ...
        val txtTemaRevista: EditText = popupView.findViewById(R.id.txtTemaRevista)

        // Configurar DatePicker

        // Botón crear revista
        val btnCrearTemaRevista: Button = popupView.findViewById(R.id.btnCrearTemaRevista)
        btnCrearTemaRevista.isEnabled = false

        // Agregar TextWatcher para monitorear cambios en los EditTexts
        txtTemaRevista.addTextChangedListener(object : TextWatcher {
            override fun beforeTextChanged(s: CharSequence?, start: Int, count: Int, after: Int) {}

            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                checkInputFields(txtTemaRevista , btnCrearTemaRevista)
            }
        ...
        btnCrearTemaRevista.setOnClickListener {
            ...
            val nombre = txtTemaRevista.text.toString()
    ...
    fun crearTemaRevista(tema: String) {
