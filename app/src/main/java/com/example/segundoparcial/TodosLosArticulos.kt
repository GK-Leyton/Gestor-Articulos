...
class TodosLosArticulos : AppCompatActivity() {
    private lateinit var recyclerView: RecyclerView
    private lateinit var articleAdapter: ArticleAdapter
    private lateinit var searchBar: EditText
    private val articleList = mutableListOf<Articulo>()
    var url = URL.BASE_URL+"Articulos/ObtenerTodosLosArticulos.php"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        articleAdapter = ArticleAdapter(articleList, this , idUsuario.toString() , tipoUsuario.toString() , "TodosLosArticulos")
