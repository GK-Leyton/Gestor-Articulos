...
class ArticulosEnDespacho : AppCompatActivity() {
    private lateinit var recyclerView: RecyclerView
    private lateinit var articleAdapter: ArticleAdapter
    private lateinit var searchBar: EditText
    private val articleList = mutableListOf<Articulo>()
    var url = URL.BASE_URL+"Articulos/ObtenerTodosLosArticulosPrestadosDeUnInvestigadorPorId.php"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        obtenerPrestamosPorUsuario(idUsuario.toString().toInt())
       // obtenerPrestamosPorUsuario(1)
        ...
        articleAdapter = ArticleAdapter(articleList, this , idUsuario.toString() , tipoUsuario.toString() , "ArticulosEnDespacho");
    ...
    fun obtenerPrestamosPorUsuario(idUsuario: Int) {
