...
class EdicionAdapter(private val articulosList: List<ArticuloDesdeActa>, private val context: Context , private val idUsuario: String , private val tipoUsuario: String) :
    RecyclerView.Adapter<EdicionAdapter.ArticuloViewHolder>() {
