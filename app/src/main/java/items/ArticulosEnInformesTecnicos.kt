...
class ArticulosEnInformesTecnicos(private val edicionesList: List<EdicionDesdeRevista>, private val context: Context, private val idUsuario: String, private val tipoUsuario: String, private val idInforme: String ) :
    RecyclerView.Adapter<ArticulosEnInformesTecnicos.ArticuloViewHolder>() {
        ...
        fun bind(edicion: EdicionDesdeRevista) {
            ...
            itemView.setOnClickListener {
                val intent = Intent(context, PantallaDeCarga::class.java).apply {
                    ...
                    putExtra("idInforme", idInforme)
                    putExtra("idUsuario", idUsuario)
                    putExtra("tipoUsuario", tipoUsuario)
                    putExtra("idArticulo", edicion.id)
                }
